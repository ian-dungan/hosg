...
class World {
    constructor(scene, options = {}) {
        ...
        // Expose helpers on the scene for AI and other systems
        this.scene.world = this;
        this.scene.getHeightAt = this.getHeightAt.bind(this);
    }
    ...
    createLights() {
        ...
        // Expose shadow generator on the scene so other systems can use it
